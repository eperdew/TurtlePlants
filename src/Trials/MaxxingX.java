...
public class MaxxingX {
	...
	public static final int NUM_EVALUATIONS = 100000;
	
	public static void main(String[] args){
		/* W represents forward,
		 * Q and E are roll left and right,
		 * F and R are down and up
		 * A and D are turn left and right
		 */
		Alphabet alpha = new Alphabet("WQEFRAD");
		Evaluator eval = new MaxX();
		...
		interp.put("W", new Instruction(Move.FORWARD,.02));
		...
		TurtleInstructions.TurtleRenderer.render(express.imap.fromString(pop.elite.ls.current));
	}
