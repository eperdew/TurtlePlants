...
public class MaxxingLengthStack {
	...
	public static void main(String[] args) {
		 ...
		 */
		Alphabet alpha = new Alphabet("WQEFRADUO");
		Evaluator eval = new SumLength();
		...
		interp.put("U", new Instruction(Move.PUSH, 0));
		interp.put("O", new Instruction(Move.POP, 0));
